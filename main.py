...
TAMANHO_TELA = (tela_info.current_w, tela_info.current_h)
...
def rodar_jogo(grid):
    ...
    while jogo_em_execucao:
        ...
        hud_bg = pygame.Surface((600, 40), pygame.SRCALPHA)
        hud_bg.fill((30, 30, 30, 180))
        tela.blit(hud_bg, (20, TAMANHO_TELA[1] - 50))
        ...
        pygame.draw.rect(tela, (255, 255, 255), botao_sair, width=1, border_radius=10)
...
def desenhar_tabuleiro(tela, tabuleiro, visivel, encontradas, grid, offset_x, offset_y):
    ...
    for i in range(grid[1]):
        for j in range(grid[0]):
            ...
            pygame.draw.rect(tela, (255, 255, 255), rect, width=1, border_radius=12)
