...
def thread_jogador(jogador_id, semaforo_entrada, semaforo_saida, grid, tabuleiro, visivel, encontradas, pontuacao, vez_jogador, jogadas_pendentes, total_viradas, tempo_ultima_jogada):
    while True:
                ...
                if not visivel[lin][col] and not encontradas[lin][col]:
                    ...
                    if len(total_viradas) == 2:
                        ...
                        if tabuleiro[l1][c1] == tabuleiro[l2][c2]:
                            ...
                            total_viradas.clear()
                            semaforo_entrada.release()  # mesmo jogador joga de novo
                        else:
